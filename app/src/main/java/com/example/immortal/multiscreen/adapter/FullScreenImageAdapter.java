...
import com.example.immortal.multiscreen.R;
import com.example.immortal.multiscreen.helper.TouchImageView;
...
public class FullScreenImageAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        imgDisplay.setImageBitmap(bitmap, null, -1, -1);
        imgDisplay.setDisplayType(ImageViewTouchBase.DisplayType.FIT_TO_SCREEN);
